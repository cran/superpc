superpc.plotcv = function(object, cv.type = c("full", "preval"), smooth = TRUE, smooth.df = 10, call.win.metafile = FALSE, ...) {
    ...
    # if(object$type=='survival'){ ylab='Likelihood ratio test statistic'} if(object$type=='regression'){ ylab='F statistic'}
